...
import 'package:flutter_diet_tips/util/Network.dart';
...
class _SignUpPage extends State<SignUpPage> {
  ...
  Future storeUser() async {
    ...
    var data = {
      ...
      'first_name': textFirstNameController.text,
      'last_name': textLastNameController.text,
      'password':textPasswordController.text,
      'mobile':myController.text,
      'about':'New user'
    };
    var res = await Network().postAPIData(data, '/accounts/StoreUser');
          ...
          body: Container(
            ...
            child: ListView(
              children: [
                ...
                getTextFiled(S.of(context).lastName, textFirstNameController, false,'lastName'),
                getTextFiled(S.of(context).firstName, textLastNameController, false,'firstName'),
                getTextFiled(
                    S.of(context).yourEmail, textEmailController, false,'email'),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child:
                            getTextFiled("Phone Number", myController, false,'phoneNo'),
                        // child: TextField(
                ...
                getTextFiled(
                    S.of(context).password, textPasswordController, true,'password'),
  ...
  getTextFiled(String s, TextEditingController controller, bool isPass,String keyName) {
