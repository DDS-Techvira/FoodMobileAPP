...
class PrefData {
  ...
  static userName(String user) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString(username, user);
  }
  static userCodes(String code) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString(userCode, code);
  }
  static userTypes(String type) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static getUserCodes() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.getString(userCode);
  }
