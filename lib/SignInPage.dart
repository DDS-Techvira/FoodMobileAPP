...
class _SignInPage extends State<SignInPage> {
  ...
  Future storeUser() async {
    ...
    var res = await Network().postAPIData(data, '/accounts/authenticate');
    print(json.decode(res.body));
    var user_data = json.decode(res.body)["user"];
    if(json.decode(res.body)['message']=='success'){
      PrefData.setIsSignIn(true);
      PrefData.userCodes(user_data['user_code']);
      PrefData.userName(user_data['first_name']);
      PrefData.userTypes(user_data['user_type']);
          ...
          body: Container(
            ...
            child: ListView(
              children: [
                ...
                getTextFiled(
                    S.of(context).yourEmail, textEmailController, false,'email_text'),
                getTextFiled(
                    S.of(context).password, textPasswordController, true,'passwordText'),
